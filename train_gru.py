...
WINDOW=1024; TIMESTEPS=32; FEATDIM=32
OUT_TFLITE="/home/yassine/gru_bearing_int8.tflite"
OUT_KERAS="/home/yassine/gru_bearing.keras"
mlflow.set_tracking_uri("http://localhost:5000")
mlflow.set_experiment("GRU-BearingFault")
...
X = X.reshape(-1, TIMESTEPS, FEATDIM)
...
def build_gru(t, fdim, ncls):
    m = tf.keras.Sequential([
        tf.keras.Input(shape=(t, fdim)),
        tf.keras.layers.GRU(32, return_sequences=False, unroll=True),
...
try:
    ...
    print("\n[ECHEC conversion int8 GRU]:", str(e)[:400]); CONV_OK = False
if CONV_OK:
